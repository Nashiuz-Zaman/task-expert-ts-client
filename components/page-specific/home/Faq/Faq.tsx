...
// data
import { faqContent } from "@/uiData/pages/home";
...
const Faq = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] xl:grid-cols-[1fr_1.85fr] 2xl:grid-cols-[1fr_2.25fr] gap-y-7 lg:gap-0">
      ...
      <h2 className={`text-2xl font-bold 2md:text-3xl text-center lg:hidden`}>
      ...
      <div className="w-full h-full py-2 2xl:py-4 lg:pl-6 2xl:pl-9 2xl:min-h-[30rem]">
        ...
        <InnerContainer className="grid grid-cols-1 2md:grid-cols-2 lg:grid-cols-1 2xl:grid-cols-2 gap-4 lg:gap-5 lg:!pl-0">
          <div className="space-y-5">
            {set1?.map((question) => {
              return <QuestionAnswer key={question.id} data={question} />;
            })}
          </div>
